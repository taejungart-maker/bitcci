...
'평화의 힘'보다 '힘으로 유지되는 평화'를 믿는 야만의 시대, 강대국이 약소국에게 가하는 전쟁과 같은 폭력 앞에 오늘의 미술은 그 빛씨를 길어 올려 저항해야 합니다. 이는 곧 미술의 참 쓸모를 보여주는 것입니다. 전태일과 이윤복, 그 둘이 세상을 향해 던진 외마디는 어둠에서 벗어나려는 의지의 빛씨였습니다. 11살 윤복의 "가난은 죄인가요?"라는 물음은 내 죄 없이 겪어야 하는 빈곤의 구조적 폭력을 드러내는 고발이었고, 22살 태일의 "우리는 기계가 아니다"라는 외침은 소외된 노동자의 존엄을 환기하는 선언이었습니다.`,
  ...
  artworks: [
    ...
    },
    {
      ...
      description: "응시하는 것인지, 글썽이는지 알 수 없는 젊은이의 눈길에는 지나온 시간이 쌓여 있다.\n태일은 글과 영화로 윤복을 알았고, 윤복은 분신한 노동자의 뉴스로 태일을 알았다.\n태일은 22살 나이로, 윤복은 38살 나이로 세상을 떠났지만,\n서로 얼굴도 모르면서 주고받은 빛씨는 오늘 우리에게 심어졌다.\n우리는 어떻게 살아갈 것인가?",
      maxHeight: "calc(100vh - 350px)",
    },
    // 김재석
    {
      ...
      description: "그게 말이지, 종일 노동에 시달리다 보면 파김치가 된 몸이 짐이 되더란 말이지. 집에 와 널브러져서 생각해보면 '이 몸이 없으면 뭣해서 먹고사나?'싶더군. 그래, 마르긴 해도 통뼈잖아, 이 몸이 날 살리는 도구더라구. 겨우 몸을 일으켜 씻는데, 자주 거울에 눈길이 가데. 내 살아온 시간이 화석처럼 박혀있더군. 내 아버지가 그랬고, 나도 그런.",
      maxHeight: "calc(100vh - 350px)",
    },
    // 김재홍
    {
    ...
    // 남진현
    {
      ...
      description: "우리는 자연재해에서 비롯된 가난과 그 고통에 분노하는 것이 아니다.\n이기적인 사회제도가 주는 불평등과 불의는 약자를 짓밟은 대가로써 얻는 것이기에\n저항하는 것이다. 이같이 마땅한 저항은 양심을 지닌 시민의 연대로써 쟁취할 수 있다.\n서로 다른 모습처럼 다른 생각을 가진 이들이여, 정의의 이름으로 연대하자!",
      maxHeight: "calc(100vh - 350px)",
    },
    // 박건재
    {
      ...
      description: "상처와 흔적을 간직한 채 새로운 빛을 내는 존재에 관한 이야기다. 이 작품 '검은 눈물'은 인간과 시대에 얽힌 기억과 감정을 이야기하고 있다, 우리가 잃어버린 것들, 버려진 것들의 아픔을 느끼며 공감할 때, 우리는 비로소 깨어나며, 눈물을 통해 치유의 카타르시스를 제공하며, 연결을 느끼고, 또 새로움을 발견할 수 있을지 묻는다.",
      maxHeight: "calc(100vh - 350px)",
      darkBg: true,
    },
    {
    ...
    // 성효숙
    {
      ...
      description: "전태일을 알게 되고 노동 현장을 가게 된 지 수십 년이 된 어느 날, <아르떼숲>이 놓은 징검다리에서 전태일의 빛씨를 머금고 있음을 알게 되었다. 우리가 꽃피울 차례다.",
      maxHeight: "calc(100vh - 350px)",
    },
    // 송주웅
    {
    ...
    // 신현경
    {
      ...
      description: "폭압 착취자들은 약자의 피를 먹고 득세한다. 그들만의 도시는 휘황찬란하지만 윤복의 저 하늘에는 슬픔이 가시지 않았고, 태일의 '집'은 어디에도 없다. 하지만 태일의 불꽃은 키세쓰(Kisses)로 다시 살아나 세상을 비춘다. 나도 촛불을 든다.",
      maxHeight: "calc(100vh - 350px)",
    },
    {
      id: 26,
      ...
      description: "살아서도 죽어서도 어디에도 없는 태일의 집에 천부경이 들어선다. 하나가 시작되나 시작이 없는 하나는 일시무시일(一始無始一) 삼(三)을 낳고 다시 돌아와 그 하나는 끝나지만 끝나지 않는 태일(太一)의 하나이다. 일시무시일(一始無始一), 그곳에는 스스로 살라 빛을 밝힌 광명(光明) 태일이 있다.",
      maxHeight: "calc(100vh - 350px)",
    },
    // 유대수
    {
      ...
      description: "생의 지층이 쌓일수록 꿈의 씨, 빛씨도 함께 쌓이고 자란다. 가난은 죄가 아니고, 노동은 삶의 전체다. 그러므로 너는 나다. '그대들이 아는 그대들의 전체의 일부인 나'는 너다.",
      maxHeight: "calc(100vh - 350px)",
    },
    {
      id: 35,
      ...
      description: "\"다만 저 거덜난 잿더미 속 자네의 맨 밑두리엔 우주의 깊이보다 더 위대한 노여움 꺼질 수 없는 사람의 목숨이 있을지니 바로 그 불꽃으로 하여 자기를 지피시라\" (백기완)\n\n그때는 그랬다. 술을 마시거나 연애를 하거나 선생이 되고 싶어도 목숨을 걸으라 했다. 진짜가 되려거든 그만한 각성과 진정을 가지라는 말이다. 지금도 그렇다.",
      maxHeight: "calc(100vh - 350px)",
    },
    // 이경성
    {
      ...
      description: "타오르는 장작은 개인의 죽음이 사회적 운동으로 확장되는 과정을 은유한다.\n불은 사상과 행동, 역사적 에너지의 품고 있다.\n검게 그을린 장작은 신체라는 외면을, 붉은 생걸은 의식의 내면을 드러낸다.\n상단의 책과 권총의 중첩된 형상은 의식이 실천으로 전환되는 '트리거(Trigger)'를 상징한다.\n촛불은 개별 형상이 아닌 불꽃 전체에 내재하며 집합적 에너지를 암시한다.\n이 작품은 소멸이 아닌 생성으로서, 세계를 움직이는 의식과 실천을 시각화했다.\n............\n생걸 : 불이 다시 살아날 수 있는 불씨를 일컫는 토박이말",
      maxHeight: "calc(100vh - 350px)",
    },
    // 이달비
    {
      ...
      description: "불에 타서 재가 된 줄 알았던 몸뚱이. 그러나 봄바람이 스미자 그 속에서 새순이 튼다. 그의 죽음은 끝이 아니었다. 오히려 수많은 움이 돋아나 노동의 봄을 열었다.",
      maxHeight: "calc(100vh - 350px)",
    },
    {
      id: 24,
      ...
      description: "검게 탄 나무에 봄볕이 스몄다. 그 속에 빛씨가 꿈틀거리더니 새 움이 튼다. 그의 죽음은 끝이 아니었다.",
      maxHeight: "calc(100vh - 350px)",
    },
    // 이운구
    {
      ...
      description: "전태일, 이재명, 이윤복. 이들의 따뜻한 연대는 우리 공동체가 지향할 대동(大同)세상을 꿈꾸게 한다.",
      maxHeight: "calc(100vh - 350px)",
    },
    // 이흥덕
    {
    ...
    // 전진경
    {
      ...
      description: "해고된 노동자가 자신의 일터 앞에서 고공농성을 하고 있다. 나는 그 현장에서 드로잉을 수행한다. 나의 드로잉은 기록이 아니라 동참하는 것이다. 지나가는 사람들은 내가 무엇을 그리는지 궁금해하며 걸음을 멈추고 바라본다. 그 순간 드로잉은 공적 행위가 되고 사건이 된다.",
      maxHeight: "calc(100vh - 350px)",
    },
    // 정영창
    {
    ...
    // 천광호
    {
      ...
      description: "호박은 거친 들에서 줄기를 뻗으며 끈질기게 자란다. 태일의 가족이 살았던 대구 남산동 집은 양철 지붕에 벽체는 판자와 골판지로 얼기설기 바람만 막았다. 그 좁은 단칸방에 미싱 한 대와 일곱의 식구가 살았다. 그러나 태일은 그때가 인생에서 가장 행복했다고 했다. 껌을 팔기 위해 나선 윤복은 태일의 집 지나간다.",
      maxHeight: "calc(100vh - 350px)",
    },
    {
      id: 37,
      ...
      description: "전태일이 살았던 집은 지금 자취가 없다. 태일은 그 시절이 (윤복이 다니던 명덕국민학교 안에 있던 야학을 다니던) 가장 행복했단다. 어느날 그 곳에 호박꽃이 활짝 피어 있었다. 태일이 웃고 있는 모습 같아서 크게 확대해서 그렸다. (당시 내가 본 모습은 지붕이 내려앉아 있었다. 지금은 시민의 모금으로 '전태일기념관'이 들어서 있다.)",
      maxHeight: "calc(100vh - 350px)",
    },
    // 하성흡
    {
      ...
      description: "전태일과 이윤복의 가난을 극복하려는 저항은 새로운 봄볕을 데려왔다. 윤복이 어둠을 이겨 태일에게 그 빛씨를 심었기 때문이고, 태일이 태산을 옮겨 그 빛씨를 우리에게 심은 까닭이다. 이제 우리가 이 빛씨를 피워내야 한다.",
      maxHeight: "calc(100vh - 350px)",
    },
  ]
};
