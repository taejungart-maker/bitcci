...
'평화의 힘'보다 '힘으로 유지되는 평화'를 믿는 야만의 시대, 강대국이 약소국에게 가하는 전쟁과 같은 폭력 앞에 오늘의 미술은 그 빛씨를 길어 올려 저항해야 합니다. 이는 곧 미술의 참 쓸모를 보여주는 것입니다. 전태일과 이윤복, 그 둘이 세상을 향해 던진 외마디는 어둠에서 벗어나려는 의지의 빛씨였습니다. 11살 윤복의 "가난은 죄인가요?"라는 물음은 내 죄 없이 겪어야 하는 빈곤의 구조적 폭력을 드러내는 고발이었고, 22살 태일의 "우리는 기계가 아니다"라는 외침은 소외된 노동자의 존엄을 환기하는 선언이었습니다.`,
  ...
  artworks: [
    ...
    // 노경근
    {
      id: 43,
      artist: "노경근",
      title: "빛씨의 계보; 대체되지 않는 것들",
      material: "두방지에 먹",
      size: "70×75cm(2ea)",
      year: "2026",
      image: "artworks/43.png",
      description: "과거의 시간은 곧 미래의 시간이 된다.\n윤복이 남긴 가난의 기록은\n태일의 가슴에 저항의 '빛씨'가 되었다.\n그 빛씨를 받은 우리는 혼란스럽다.\n자신을 불살라서 노동자도 사람임을 외친\n태일의 불탄 손,\n이 손을 후대는 인간의 육체노동을 대체해 나가는\n휴머노이드로 그려내지 않을까?\n\"우리는 기계가 아니다\"라던 태일의 외마디가\n무색하게 인간의 자리마저 피지컬 AI로 대체되는 시대.\n로봇으로 인간의 노동을 대신할 'AI인류'는\n태일이 외친 노동의 가치와 존엄을 어떻게 이해할까?\nAI는 인간의 도구로만 남을까?",
      maxHeight: "calc(100vh - 350px)",
    },
    // 박건재
    {
    ...
    // 천광호
    {
      ...
      description: "호박은 거친 들에서 줄기를 뻗으며 끈질기게 자란다.\n태일의 가족이 살았던 대구 남산동 집은\n양철 지붕에 벽체는 판자와 골판지로 얼기설기 바람만 막았다.\n그 좁은 단칸방에 미싱 한 대와 일곱의 식구가 살았다.\n그러나 태일은 그때가 인생에서 가장 행복했다고 했다.\n껌을 팔기 위해 나선 윤복은 태일의 집 지나간다.\n(가장 척박한 땅에서 호박꽃은 핀다.\n호박꽃처럼 기어이 핀 두 사람을 그렸다.)",
      maxHeight: "calc(100vh - 350px)",
    },
    {
      id: 37,
      ...
      description: "전태일이 살았던 집은 지금 자취가 없다.\n태일은 그 시절이 가장 행복했단다.\n어느날 그 곳에 호박꽃이 활짝 피어 있었다.\n태일이 웃고 있는 모습 같아서 크게 확대해서 그렸다.\n(당시 내가 본 모습은 지붕이 내려앉아 있었다.\n지금은 시민의 모금으로 '전태일기념관'이 들어서 있다.)",
      maxHeight: "calc(100vh - 350px)",
    },
    // 하성흡
    {
      ...
      description: "전태일과 이윤복의\n가난을 극복하려는 저항은 새로운 봄볕을 데려왔다.\n윤복이 어둠을 이겨 태일에게 그 빛씨를 심었기 때문이고,\n그 둘이 태산을 옮겨 그 빛씨를 우리에게 심은 까닭이다.\n이제 우리가 이 빛씨를 피워내야 한다.",
      maxHeight: "calc(100vh - 350px)",
    },
  ]
};
